"""
Blueprint: Contrato
Rotas: /contrato, /contrato/visualizar
"""
import os
...
# A rota /contrato/assets/<filename> foi REMOVIDA em 30/05/2026.
# Apontava pra design_handoff_solev_brand/ que foi deletada na limpeza
# (handoff superseded por solev-logo/). O template contrato_pdf.html agora
# referencia /static/logo/solev-wordmark-areia.svg diretamente.
